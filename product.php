...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Dish and Service Form
                <small>Preview</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Forms</a></li>
                <li class="active">Dish and Service Form</li>
            </ol>
        </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_1" data-toggle="tab">Dish</a></li>
                                    <li ><a href="#tab_2" data-toggle="tab">Service</a></li>
                                    <li><a href="#tab_3" data-toggle="tab">Raw Materials</a></li>

                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                        <b> <i class="fa fa-cutlery"></i> Dish:</b>
