...
?>
    ...
    <h2 style="color: #fff; margin:20px"><?php echo $row['room_no']; ?></h2>
    <p style="color: #B6B6B6; margin:-10px 30px 30px 30px; font-size:20px"><?php echo $vehicle=$row['cus_name']; ?>
    </p>
    <br>
    <div
		...
		for($i3=0; $rowm = $resultm->fetch(); $i3++){
		 echo number_format($rowm['sum(price)'],2);
                ...
                <td><a href="sales.php?id=<?php echo $invo; ?>">
                        <div class="btn"
