                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control select2" name="category" style="width: 100%;"
                                            ...
                                            <?php
                                                                            $result = $db->prepare("SELECT * FROM products WHERE type='dish'  ");
		                                                                        $result->bindParam(':userid', $res);
		                                                                        $result->execute();
		                                                                        for($i=0; $row = $result->fetch(); $i++){
	                                                                         ?>
                                            <option value="<?php echo $row['id'];?>">
                                                <?php echo $row['product_name']; ?> __
                                                Rs.<?php echo $row['sell_price'];?>
                                            </option>
                                            <?php }    ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3"> <label>Type</label>
                                        <select class="form-control select2" name="type" id="type" style="width: 100%;">
                                            ...
                                            <option value="breakfast_dessert">Breakfast Dessert</option>
                                            <option value="lunth">Lunch</option>
...
?>
    ...
    function matadd() {
        ...
        xmlhttp.open("GET", "package_list_save.php?mat=" + mat + "&qty=" + qty + "&type=" + type, true);
        xmlhttp.send();
    }
